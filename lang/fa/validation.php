...
return [
    ...
    'enum' => 'فیلد انتخاب شده :attribute معتبر نیست.',
    ...
    'json' => ':attribute باید یک JSON باشد.',
    'max' => [
    ...
    'attributes' => [
        ...
        "code" => "کد ورود",
        "json" => "داده",
        "accounting_app" => "نرم افزار حسابداری",
        "db_server" => "سرور پایگاه داده",
        "db_year" => "سال پایگاه داده",
        ...
        "projects" => "پروژه ها",
        "job" => "شغل",
        "next_activity" => "پیگیری بعدی",
        "thumbnail" => "عکس پیش نمایش",
        "images" => "عکس ها",
